...
swiftc -O -module-cache-path "$PWD/build/module-cache" -target arm64-apple-macosx13.0 -framework AppKit -framework UniformTypeIdentifiers Sources/Document.swift Sources/Fluent.swift Sources/Canvas.swift Sources/Ribbon.swift Sources/App.swift Sources/main.swift -o build/Paint.app/Contents/MacOS/Paint
